  ...
  <div class="h-full flex flex-col">
    ...
    <div class="flex items-center justify-between p-4 border-b">
      <div class="flex items-center">
        ...
        <span v-if="currentConversation" class="ml-2 px-2 py-0.5 text-xs rounded-full bg-blue-100 text-blue-800">
    ...
    <div class="flex-1 overflow-y-auto p-4 bg-gray-50" ref="messagesContainer">
      <div v-if="!currentConversation && messages.length === 0" class="h-full flex flex-col items-center justify-center text-gray-500">
        <svg class="h-16 w-16 mb-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <form @submit.prevent="sendMessage" class="flex items-end">
        <div class="flex-1 min-h-[40px]">
          <textarea
            ...
            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 resize-none"
            :rows="textareaRows"
        ...
        <button
          type="submit"
          class="ml-3 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50"
